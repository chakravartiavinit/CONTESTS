...
/*###############################################################################################################################################*/
int convert_To_Len_th_base(int n,
                           vector<int> arr,
                           int len,
                           int L)
{
    ...
    for (int i = 0; i < L; i++)
    {
        answer.push_back(arr[n % len]);
        n /= len;
    }
    int alpha = 0;
    // debug(answer);
    for (int i = 1; i + 1 < answer.size(); ++i)
    {
...
int main()
{
    ...
    while (t--)
    {
        ...
        else
        {
            ...
            int len = 3;
            int answer = 0;
            for (int i = 0; i < pow(len, n); i++)
            {
                answer += convert_To_Len_th_base(i, arr, len, n);
            }
            cout << answer << "\n";
        }
    }
